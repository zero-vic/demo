...
public class UserSessionUtils {
     ...
     * @return
     */
    public List<UserSession> getUserSession(String siteId, String userId) {
     ...
     * @return
     */
    public UserSession getUserSession(String siteId, String userId, Integer clientType, String imei) {
