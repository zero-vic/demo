...
//        byte[] siteIdData = new byte[siteIdLength];
//        in.readBytes(siteIdData);
//        String siteId = new String(siteIdData);
        // 请求体
...
//        messageHeader.setSiteIdLength(siteIdLength);
