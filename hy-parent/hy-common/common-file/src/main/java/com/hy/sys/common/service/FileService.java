package com.hy.sys.common.service;
...
public class FileService {
     ...
     * @throws IOException
     */
    public String uploadFile(MultipartFile file, String prefix, List<String> fileTypes,Long limitFileSize, FileUploadDto fileDto) throws IOException {
        //获取文件原始名称
     ...
     * @throws IOException
     */
    public String uploadFile(MultipartFile file, String prefix, String fileType,Long limitFileSize, FileUploadDto fileDto) throws IOException {
        //获取文件原始名称
        String originalFilename = file.getOriginalFilename();
        // 获取文件类型
        String contentType = FileUtil.extName(originalFilename);
     ...
     * @throws IOException
     */
    public String uploadFile(MultipartFile file, String prefix, List<String> fileTypes, FileUploadDto fileDto) throws IOException {
        //获取文件原始名称
        String originalFilename = file.getOriginalFilename();
        // 获取文件类型
        String contentType = FileUtil.extName(originalFilename);
    ...
    private String uploadFile(MultipartFile file,String prefix,FileUploadDto fileDto) throws IOException {
        //获取文件原始名称
        String originalFilename = file.getOriginalFilename();
        // 获取文件类型
        String contentType = FileUtil.extName(originalFilename);
